...
#SBATCH --job-name=SimPle-freeway
...
# source /home/iliaskar/projects/def-mseltzer/iliaskar/model-based-atari/ENV/bin/activate
...
cd /home/iliaskar/projects/def-mseltzer/iliaskar/model-based-atari
